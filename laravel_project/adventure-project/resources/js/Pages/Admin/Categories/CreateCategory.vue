            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex justify-end gap-3 pt-4 border-t border-slate-100">
                        ...
                        <button type="submit" :disabled="form.processing" class="bg-green-700 hover:bg-green-800 text-white font-bold px-8 py-3 rounded-xl shadow-lg transition">Save Category</button>
                    </div>
                </form>
            </div>
        </div>
